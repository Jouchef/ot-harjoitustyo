...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_neq_summan_lataaminen_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-100)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    
    def test_voi_ostaa_edullisen_lounaan_jos_saldoa(self):
        self.kortti.syo_edullisesti()

        self.assertEqual(self.kortti.saldo_euroina(), 7.5)

    def test_voi_ostaa_maukkaan_lounaan_jos_saldoa(self):
        self.kortti.syo_maukkaasti()
